const r = requireOriginalNodeRaylibWrapper();
 ...
 *
 * This version specifies the `original_older_release.node` DLL when running .dlopen
 *  
 ...
 */
function requireOriginalNodeRaylibWrapper() {
    /**
     * node-raylib
     *
     * @module raylib
    ...
    process.dlopen(
        importmodule, 
        path.join(__dirname, '..', 'dlls', 'original_older_release.node'),
